...
const AddJob = () => {
    const {
        ...
        position, company,
        jobLocation, jobType,
        jobTypeOptions, status,
        statusOptions, handleChange,
        clearValues, createJob, editJob,
    } = useAppContext()
        ...
        <Wrapper>
            <form className='form'>
                ...
                <div className='form-center'>
                    ...
                    <FormRow type='text' labelText='job location' name='jobLocation' value={jobLocation}
